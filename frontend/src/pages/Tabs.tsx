...
import { barChart, home, people, planet, receipt, settings } from 'ionicons/icons';
  ...
  return (
    <IonTabs>
      <IonRouterOutlet>
        ...
        <Route path="/tabs/charges" element={<Navigate to="/tabs/global" replace />} />
        <Route path="/tabs/global" element={<Global />} />
        <Route path="/tabs/expenses/add" element={<AddExpense />} />
        <Route path="/tabs/debts/add" element={<AddDebt />} />
      ...
      <IonTabBar slot="bottom">
        ...
        <IonTabButton tab="global" href="/tabs/global">
          <IonIcon icon={planet} />
